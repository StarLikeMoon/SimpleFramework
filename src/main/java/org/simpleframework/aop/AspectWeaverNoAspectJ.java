...
import org.simpleframework.aop.ProxyCreator;
...
/**
 * 将横切逻辑织入到被代理的对象中，不利用AspectJ，这种方式只能支持注解级别的joinpoint
 * 在AOP2.0中引入了AspectJ，此种方式已经废弃
 */
@Deprecated
public class AspectWeaverNoAspectJ {

    private BeanContainer beanContainer;

    public AspectWeaverNoAspectJ() {
        // 获取容器，容器是绝对单例的
    ...
    public void doAop() {
        ...
        // 由于引入了Aspectj的pointcut表达式，这里再根据注解类型去分类就没有意义了
        // 2.将切面类按照不同的织入目标进行切分
